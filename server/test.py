...
from profiles import get_student_uni_id
import pytest
...
# TODO: these tests are not working, please look up how to write unit tests
...
# not working for some reason now, was working yesterday. not enough time to worry about this now
